    ...
    <nav class="navbar navbar-expand-lg main-navbar sticky">
      ...
      <ul class="navbar-nav navbar-right">
          ...
          <div class="dropdown-menu dropdown-list dropdown-menu-right pullDown">
            ...
            <div class="dropdown-list-content dropdown-list-message">
              <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar
                  ...
                  <img alt="image" src="assets/backend/img/users/user-2.png" class="rounded-circle">
                  ...
                  <img alt="image" src="assets/backend/img/users/user-5.png" class="rounded-circle">
                </span> <span class="dropdown-item-desc"> <span class="message-user">Jacob
                    Ryan</span> <span class="time messege-text">Your payment invoice is
                    generated.</span> <span class="time">12 Min Ago</span>
                </span>
              </a> <a href="#" class="dropdown-item"> <span class="dropdown-item-avatar text-white">
                  <img alt="image" src="assets/backend/img/users/user-4.png" class="rounded-circle">
                  ...
                  <img alt="image" src="assets/backend/img/users/user-3.png" class="rounded-circle">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown"
            class="nav-link dropdown-toggle nav-link-lg nav-link-user"> <img alt="image" src="assets/backend/img/user.png"
    ...
    <div class="main-sidebar sidebar-style-2">
      <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="dropdown">
            <a href="{{route('home')}}" class=" nav-link "><i data-feather="command"></i><span>Home</span></a>
          </li>
          <li class="dropdown">
          ...
          <li class="dropdown">
            <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>Settings</span></a>
            <ul class="dropdown-menu">
              <li><a class="nav-link" href="email-inbox.html">Infos</a></li>
              <li><a class="nav-link" href="email-compose.html">Skills</a></li>
              <li><a class="nav-link" href="email-read.html">Experiance & Education</a></li>
          ...
          <li class="dropdown">
            <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="mail"></i><span>Webget</span></a>
            <ul class="dropdown-menu">
              <li><a class="nav-link" href="email-inbox.html">Infos</a></li>
              <li><a class="nav-link" href="email-compose.html">Skills</a></li>
              <li><a class="nav-link" href="email-read.html">Experiance & Education</a></li>
